...
class Menu extends \EmailWP\Common\Plugin\Menu
{
    ...
    {
        wp_register_script($this->properties->plugin_domain . '-bundle', plugin_dir_url($this->properties->plugin_file_path) . 'dist/js/core.js', array('wp-polyfill', 'regenerator-runtime'), $this->properties->plugin_version, 'all');
